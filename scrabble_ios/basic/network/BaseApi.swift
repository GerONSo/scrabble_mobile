...
class BaseApi {
    ...
    static func makeRequest<T: Decodable>(httpMethod: String, endpoint: String, requestData: Encodable? = nil, authorizationToken: String? = nil, resultCompletion: @escaping (Result<T>) -> Void) {
